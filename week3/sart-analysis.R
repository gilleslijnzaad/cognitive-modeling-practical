...
# Read in the data
data_path <- "C:/Users/shild/Documents/AI/Jaar 2/Blok 3/Cognitive Modelling Practical/week 3/" # Change to the location of your output folder
...
plot <- ggplot()
plot + geom_line(activations_at, mapping = aes(x=time, y=activation), color='darkgreen') + 
  geom_line(activations_wa, mapping = aes(x=time, y=activation), color='darkblue') +
  xlim(1,500) + 
  ylim(4.5,6) + 
